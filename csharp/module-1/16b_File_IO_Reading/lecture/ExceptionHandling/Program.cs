...
namespace ExceptionHandling
{
    class Program
    {
        ...
        //throw an exception
        //raise an exception
        //issues will keep looking through different classes of code to find something to take care of an exception before the machien spits it out

        //DivideByZeroException
        //IndexOutOfRangeException
        //FormatException

        //IndexOutOfRange: trying to use sometning that does not exist due to length
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine(cities[3]);  // This statement will throw an IndexOutOfRangeException, index 3 does not exist
            Console.WriteLine("are all in Ohio."); // This line won't execute because the previous statement throws an Exception
            }
            catch (IndexOutOfRangeException e)
                //handle the exception
                //looks like a method, exception object is IndexOutOfRange, exception is type, ex is name
                //usually has a write line
            {
                // Flow of control resumes here after the Exception is thrown
                Console.WriteLine("XXX   Uh-oh, something went wrong...   XXX");
                Console.WriteLine(e.Message);
                //e.Message: basic index out of array statement
            }

            //fnally{}
            //  executes this code no matter what happens above, optional
            ...
            */
            try
            {
                ...
                DoSomethingDangerous();  // this method throws an ArrayIndexOutOfBoundsException
            ...
            */
            ...
            //will catch any exception that occurs, mainly from that readline thru int parse
            {   // If a FormatException is thrown by int.Parse(...)
                ...
                Console.WriteLine(e.Message);
                //will throw exception if you write one instead of 1
            }
      ...
      * see the source code of calculateHotelRoomCharges for an example
            ...
            */
            ...
            //9 times out of 10 c# exceptions are good enough
            ...
            //created our own exception from oerdrive exception class
            {
                Console.WriteLine("An overdraft exception was caught");
                Console.WriteLine(ex.Message);
            }
            finally
            //returns message no matter what
            {
        ...
        */
        private static double CalculateHotelRoomCharges(int nights, int numberOfGuests)
        {
            ...
            //throw: keyword for putting exceptions into code
