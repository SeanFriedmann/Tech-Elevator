...
{
    public static class ReadingCSVFiles //comma seperated value
    {
        /*
        ...
        */
        ...
        public static void ReadFile()
        {
            ...
            List<string> allWords = new List<string>(); //place each individual word in the list of allWords
            ...
            try
            {
                ...
                using (StreamReader sr = new StreamReader(fullPath))
                {
                    ...
                    while (!sr.EndOfStream)
                    {
                        ...
                        allWords.AddRange(words); //add array values to list, instead of convoluted for loop
            ...
            {
                Console.WriteLine(word); //print out each word in the list
            }
        }
    }
}
