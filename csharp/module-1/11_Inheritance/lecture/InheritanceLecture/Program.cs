...
namespace InheritanceLecture
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Auction generalAuction = new Auction(); //call constructor for auction, no defined constructor (no arg constructor)
            ...
            generalAuction.EndAuction();//dont forget paranthessi on methods

            generalAuction.PlaceBid(new Bid("David", 51));

            //Buyout
            //gains functionality inherited from auction
            //child can only have 1 parent, can use : for other things
            Console.WriteLine("Starting a Buyout Auction.");
            Console.WriteLine("-------------------------");
            BuyoutAuction buyoutAuction = new BuyoutAuction(1000); //add buyout price here
