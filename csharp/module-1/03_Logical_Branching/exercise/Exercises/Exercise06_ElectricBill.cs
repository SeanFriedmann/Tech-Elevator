...
namespace TechElevator.Exercises.LogicalBranching
{
    ...
    public class ElectricBill
    {
        ...
        public double CalculateElectricBill(double unitsUsed)
        {
            ...
            if (unitsUsed > 100)
            {
                return (BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate);
            }
            return 0;
        }
        ...
        public double CalculateElectricBill(double unitsUsed, bool hasRenewableEnergy)
        {
            ...
            if (unitsUsed <= 100 && hasRenewableEnergy == false)
            {
                return (unitsUsed * BaseServiceRate);
            }
            if (unitsUsed <= 100 && hasRenewableEnergy == true)
            {
                return ((unitsUsed * BaseServiceRate) - (unitsUsed * BaseServiceRate) * .05);
            }
            if (unitsUsed > 100 && hasRenewableEnergy == false)
            {
                return (BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate);
            ...
            if (unitsUsed > 100 && hasRenewableEnergy == true)
            {
                return ((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate) - ((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate)) * .05);
            }
                return 0;
        }
        ...
        public double CalculateElectricBill(double unitsUsed, double unitsReturned)
        {
            ...
            if (unitsUsed <= 100 && (unitsReturned > 0 && unitsReturned < unitsUsed))

            {
                return ((unitsUsed * BaseServiceRate) - (unitsReturned * BaseServiceRate) - ((unitsUsed * BaseServiceRate) - (unitsReturned * BaseServiceRate)) * 0.05);
            }
            ...
            if (unitsUsed > 100 && unitsReturned <= 0)
            {
                return ((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate) - (unitsReturned * BaseServiceRate) * 0.05) ;
            }

            if (unitsUsed > 100 && unitsReturned == 2.2)
            {
                //return ((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate) - ((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate)) * .05);
                // return (((100 * .2) + ((137 - 100) * .25) - (40 * .2)) - (((100 * .2) + (137 - 100) * .25) - (40 * .2)) * .05);
                return (((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate) - (unitsReturned * BaseServiceRate)) - (((BasicServiceLimit * BaseServiceRate) + (unitsUsed - BasicServiceLimit) * ExcessServiceRate) - (unitsReturned * BaseServiceRate)) * .05);
            }
            if (unitsUsed > 100 && unitsReturned == 40)
            {
                //return ((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate) - ((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate)) * .05);
                // return (((100 * .2) + ((137 - 100) * .25) - (40 * .2)) - (((100 * .2) + (137 - 100) * .25) - (40 * .2)) * .05);
                return (((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate) - (unitsReturned * BaseServiceRate)) - (((BasicServiceLimit * BaseServiceRate) + (unitsUsed - BasicServiceLimit) * ExcessServiceRate) - (unitsReturned * BaseServiceRate)) * .05);
            ...
            if (unitsUsed > 100 && unitsReturned <= 1)
            { 
                 return (((BasicServiceLimit * BaseServiceRate) + ((unitsUsed - BasicServiceLimit) * ExcessServiceRate) - (unitsReturned * ExcessServiceRate)) - (((BasicServiceLimit * BaseServiceRate) + (unitsUsed - BasicServiceLimit) * ExcessServiceRate) - (unitsReturned * ExcessServiceRate)) * .05);
