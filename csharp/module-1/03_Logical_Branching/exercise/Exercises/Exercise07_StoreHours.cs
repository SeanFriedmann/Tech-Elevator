...
namespace TechElevator.Exercises.LogicalBranching
{
    ...
    public class StoreHours
    {
        ...
        {
            if (currentHour >= 8 && currentHour <= 16 && currentHour != 0)
            {
                return true;
            }
            return false;
        ...
        {
            if (currentHour >= 8 && currentHour <= 16 && currentHour != 0 && currentDay == 'M') //|| currentDay == 'W' || currentDay == 'F'))
            {
                return true;
            }
            if (currentHour >= 8 && currentHour <= 16 && currentHour != 0 && currentDay == 'W') //|| currentDay == 'W' || currentDay == 'F'))
            {
                return true;
            }
            if (currentHour >= 8 && currentHour <= 16 && currentHour != 0 && currentDay == 'F') //|| currentDay == 'W' || currentDay == 'F'))
            {
                return true;
            }
            return false;
        ...
        public bool IsStoreOpen(int currentHour, char currentDay, bool isSummer)
        {
            if (isSummer == false)
            {
                if (currentHour >= 8 && currentHour <= 16 && currentHour != 0 && currentDay == 'M')
                {
                    return true;
                }
                if (currentHour >= 8 && currentHour <= 16 && currentHour != 0 && currentDay == 'W')
                {
                    return true;
                }
                if (currentHour >= 8 && currentHour <= 16 && currentHour != 0 && currentDay == 'F')
                {
                    return true;
                }
            }
            if (isSummer == true)
            {
                ...
                if (currentHour >= 8 && currentHour <= 19 && currentHour != 0 && currentDay == 'W')
                {
                    return true;
                }
                if (currentHour >= 8 && currentHour <= 16 && currentHour != 0 && currentDay == 'F')
                ...
                if (currentHour >= 9 && currentHour <= 14 && currentHour != 0 && currentDay == 'S')
                {
                    return true;
                }
            }
