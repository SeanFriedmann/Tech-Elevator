...
namespace TechElevator.Exercises.LogicalBranching
{
    ...
    public class PackageAcceptance
    {
        ...
        {
            if (weightInPounds <= 40 && (widthInInches * lengthInInches * heightInInches) <= 6912)
            {
                return true;
            }
            else
        ...
        {
            //if (weightInPounds <= 40 && (widthInInches * lengthInInches * heightInInches) <= 6912 && lengthInInches <= 66 && widthInInches <= 66 && heightInInches <= 66 && isSurchargePaid == false)
            //{
            //    return true;
            //}

            //if (widthInInches * lengthInInches * heightInInches > 6912)
            //{
            //    return false;
            //}
            ...
            if (weightInPounds <= 40 && (widthInInches <= 66 && lengthInInches <=66 && heightInInches <=66) && (widthInInches * lengthInInches * heightInInches <= 6912)){
                return true;
            } 
            if (weightInPounds <= 40 && (widthInInches * lengthInInches * heightInInches <= 6912) && (lengthInInches <= 66 && widthInInches <= 66 && heightInInches > 66))
            {
                return true;
            }
            if (weightInPounds <= 40 && (widthInInches * lengthInInches * heightInInches <= 6912) && (lengthInInches > 66 || widthInInches > 66 || heightInInches > 66) && isSurchargePaid == true)
            {
                return true;
            }
