...
namespace HotelReservations.Controllers
{
    [Route("reservations")]
    [ApiController]
    public class ReservationsController : ControllerBase //base class for mvc controller (we dont need to worry about)
    {
        private IReservationDao reservationDao; //instance of reservationMemoryDao
