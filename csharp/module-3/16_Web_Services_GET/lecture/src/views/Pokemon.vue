<template>
    <div>
        <input id="pokemon" type="text" v-model="name"/>
        <button v-on:click="findPokemon">Clicky</button>
        ...
        <div v-for="stat in pokemon.stats" v-bind:key="stat">
            ...
            <img v-bind:src="pokemon.sprites.front_default" v-if="pokemon.name != undefined"/>
        </div>
    </div>
</template>
