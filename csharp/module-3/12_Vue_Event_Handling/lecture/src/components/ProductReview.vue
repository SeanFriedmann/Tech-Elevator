...
export default {
  ...
  computed: {
    ...
    //filtered reviews computed propery will return an [] of reviews 
    ...
    filteredReviews() {
      let filtered = this.reviews.filter((review) => {
        ...
        //if filter is not 0, only return views with filter value
  ...
  methods: { //methods section
    addNewReview(){
      ...
      this.resetForm(); //reset form after saving review
    }, //review array
